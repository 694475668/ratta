...
<script type="text/javascript">
	$(function() {
		...
		$('#form')
				.form(
						{
							url : '${pageContext.request.contextPath}/equipTypeController/edit',
							onSubmit : function() {
								parent.$.messager
										.progress({
	...
	<div data-options="region:'center',border:false" title=""
		...
		<form id="form" method="post">
			<table style="margin: auto">
				<th><h5></h5></th>
				<tr>
					<td><spring:message code="type" /><input name="id"
						type="hidden" value="${equipType.id }" />：</td>
				...
				<tr>
					...
					<td><input id="sn_length" name="sn_length" type="text"
						value="${equipType.sn_length }" class="easyui-validatebox span2"
						style="width: 380px;"
				...
				<tr>
					...
					<td><input name="sn_front" type="text"
						value="${equipType.sn_front }" class="easyui-validatebox span2"
						style="width: 380px;"
				...
				<tr>
					...
					<td><input id="sn_offset" name="sn_offset" type="text"
						value="${equipType.sn_offset }" class="easyui-validatebox span2"
						style="width: 380px;"
						data-options="required:true,validType:'number_max_length'">
					</td>
				</tr>
				<tr>
					...
					<td><input id="sn_offset_length" name="sn_offset_length"
						...
						value="${equipType.sn_offset_length }"
						data-options="required:true,validType:'number_max_length'">
					</td>
				</tr>
				<tr>
