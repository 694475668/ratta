						...
						<table>
							<tr>
								<td><span><input type="radio" name="sec"
										value="manual" />&nbsp;<spring:message
											code="quartz_manul_set" /></span></td>
								<td></td>
							</tr>
							<tr>
								<td></td>
								<td>
									<div class="secmanual" style="border: 0px solid #000">
										<input class="sec" type="checkbox" style="margin-left: 15px;"
											...
											style="margin-left: 15px;" value="10" />10 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="11" />11 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="12" />12 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="13" />13 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="14" />14
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="secmanual" style="border: 0px solid #000">
										<input class="sec" type="checkbox" style="margin-left: 15px;"
											...
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="17" />17 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="18" />18 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="19" />19 <input class="sec" type="checkbox"
											...
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="23" />23 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="24" />24 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="25" />25 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="26" />26 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="27" />27 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="28" />28 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="29" />29
								...
								<td>
									<div class="secmanual" style="border: 0px solid #000">
										<input class="sec" type="checkbox" style="margin-left: 15px;"
											...
											style="margin-left: 15px;" value="31" />31 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="32" />32 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="33" />33 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="34" />34 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="35" />35 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="36" />36 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="37" />37 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="38" />38 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="39" />39 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="40" />40 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="41" />41 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="42" />42 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="43" />43 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="44" />44
									</div>
								</td>
								...
								<td>
									<div class="secmanual" style="border: 0px solid #000">
										<input class="sec" type="checkbox" style="margin-left: 15px;"
											...
											style="margin-left: 15px;" value="46" />46 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="47" />47 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="48" />48 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="49" />49 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="50" />50 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="51" />51 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="52" />52 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="53" />53 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="54" />54 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="55" />55 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="56" />56 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="57" />57 <input class="sec" type="checkbox"
											style="margin-left: 15px;" value="58" />58 <input
											class="sec" type="checkbox" style="margin-left: 15px;"
											value="59" />59
									</div>
								</td>
								...
								<td>
									<div class="minmanual" style="border: 0px solid #000">
										<input class="min" type="checkbox" style="margin-left: 15px;"
											...
											style="margin-left: 15px;" value="10" />10 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="11" />11 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="12" />12 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="13" />13 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="14" />14
									</div>
								</td>
							</tr>
								...
								<td>
									<div class="minmanual" style="border: 0px solid #000">
										<input class="min" type="checkbox" style="margin-left: 15px;"
											...
											style="margin-left: 15px;" value="16" />16 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="17" />17 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="18" />18 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="19" />19 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="20" />20 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="21" />21 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="22" />22 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="23" />23 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="24" />24 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="25" />25 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="26" />26 <input
											class="min" type="checkbox" style="margin-left: 15px;"
								...
								<td>
									<div class="minmanual" style="border: 0px solid #000">
										<input class="min" type="checkbox" style="margin-left: 15px;"
											...
											style="margin-left: 15px;" value="31" />31 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="32" />32 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="33" />33 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="34" />34 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="35" />35 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="36" />36 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="37" />37 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="38" />38 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="39" />39 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="40" />40 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="41" />41 <input
											class="min" type="checkbox" style="margin-left: 15px;"
								...
								<td>
									<div class="minmanual" style="border: 0px solid #000">
										<input class="min" type="checkbox" style="margin-left: 15px;"
											...
											style="margin-left: 15px;" value="46" />46 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="47" />47 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="48" />48 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="49" />49 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="50" />50 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="51" />51 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="52" />52 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="53" />53 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="54" />54 <input
											class="min" type="checkbox" style="margin-left: 15px;"
											value="55" />55 <input class="min" type="checkbox"
											style="margin-left: 15px;" value="56" />56 <input
											class="min" type="checkbox" style="margin-left: 15px;"
								...
								<td>
									<div class="hourmanual" style="border: 0px solid #000">
										<span>AM</span> <input class="hour" type="checkbox"
											style="margin-left: 15px;" value="0" />00 <input
											class="hour" type="checkbox" style="margin-left: 15px;"
											value="1" />01 <input class="hour" type="checkbox"
											style="margin-left: 15px;" value="2" />02 <input
											class="hour" type="checkbox" style="margin-left: 15px;"
											value="3" />03 <input class="hour" type="checkbox"
											style="margin-left: 15px;" value="4" />04 <input
											class="hour" type="checkbox" style="margin-left: 15px;"
											value="5" />05 <input class="hour" type="checkbox"
											style="margin-left: 15px;" value="6" />06 <input
											class="hour" type="checkbox" style="margin-left: 15px;"
											value="7" />07 <input class="hour" type="checkbox"
											style="margin-left: 15px;" value="8" />08 <input
											class="hour" type="checkbox" style="margin-left: 15px;"
											value="9" />09 <input class="hour" type="checkbox"
											style="margin-left: 15px;" value="10" />10 <input
											class="hour" type="checkbox" style="margin-left: 15px;"
											value="11" />11
									</div>
								...
								<td>
									<div class="daymanual" style="border: 0px solid #000">
										<input class="day" type="checkbox" style="margin-left: 15px;"
											...
											class="day" type="checkbox" style="margin-left: 15px;"
											value="12" />12 <input class="day" type="checkbox"
											style="margin-left: 15px;" value="13" />13 <input
											class="day" type="checkbox" style="margin-left: 15px;"
											value="14" />14 <input class="day" type="checkbox"
											style="margin-left: 15px;" value="15" />15
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="daymanual" style="border: 0px solid #000">
										<input class="day" type="checkbox" style="margin-left: 15px;"
											...
											style="margin-left: 15px;" value="17" />17 <input
											class="day" type="checkbox" style="margin-left: 15px;"
											value="18" />18 <input class="day" type="checkbox"
											style="margin-left: 15px;" value="19" />19 <input
											class="day" type="checkbox" style="margin-left: 15px;"
											value="20" />20 <input class="day" type="checkbox"
											style="margin-left: 15px;" value="21" />21 <input
											class="day" type="checkbox" style="margin-left: 15px;"
											value="22" />22 <input class="day" type="checkbox"
											style="margin-left: 15px;" value="23" />23 <input
											class="day" type="checkbox" style="margin-left: 15px;"
											value="24" />24 <input class="day" type="checkbox"
											style="margin-left: 15px;" value="25" />25 <input
											class="day" type="checkbox" style="margin-left: 15px;"
											value="26" />26 <input class="day" type="checkbox"
											style="margin-left: 15px;" value="27" />27 <input
											class="day" type="checkbox" style="margin-left: 15px;"
											value="28" />28 <input class="day" type="checkbox"
											style="margin-left: 15px;" value="29" />29 <input
											class="day" type="checkbox" style="margin-left: 15px;"
											value="30" />30
									</div>
								</td>
