...
<script type="text/javascript">
	$(function() {
		...
		$('#form')
				.form(
						{
							url : '${pageContext.request.contextPath}/dealersController/edit',
							onSubmit : function() {
								parent.$.messager
										.progress({
...
<div class="easyui-layout" data-options="fit:true,border:false;" style="margin-top: 10px;">
	<div data-options="region:'center',border:false" title=""
		...
		<form id="form" method="post">
			<table style="margin: auto">
				...
				<tr>
					<td><spring:message code="dealers_name" /><input name="id"
						type="hidden" value="${dealers.id }" />：</td>
					<td><input name="dealersName" type="text"
						...
						value="${dealers.dealersName }"></td>
				</tr>
				<tr>
					<td><spring:message code="contact" />：</td>
					<td><input name="contact" type="text"
						value="${dealers.contact }" class="easyui-validatebox span2"
						style="width: 380px;"
				...
				<tr>
					...
					<td><input id="phone" name="phone" type="text"
						value="${dealers.phone }" class="easyui-validatebox span2"
						style="width: 380px;"
				...
				<tr>
					...
					<td><input id="address" name="address" type="text"
						value="${dealers.address }" class="easyui-validatebox span2"
						style="width: 380px;"
				...
				<tr>
					...
					<td><input id="salesman" name="salesman" type="text"
						value="${dealers.salesman }" class="easyui-validatebox span2"
						style="width: 380px;"
				...
				<tr style="height: 60px;">
					...
					<td><input id="remark" name="remark" type="text"
						value="${dealers.remark }" class="easyui-validatebox span2"
						style="width: 380px;"
