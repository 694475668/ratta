...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/dataDictController/addTable',
			onSubmit : function() {
	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		<form id="form" method="post">
			<table style="margin:auto">
				<tr>
					<td>表名</td>
					<td><input name="name" style="margin-top:15px;width:320px;height:14px;" type="text" class="easyui-validatebox span2" data-options="required:true,validType:'maxLength[50]'" /></td>
					</tr>
					<tr>
					<td>类型</td>
					<td>
				...
				<tr>
					<td>描述</td>
					<td><textarea name="description" style="width:320px;"  class="span5"  maxlength="100"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
