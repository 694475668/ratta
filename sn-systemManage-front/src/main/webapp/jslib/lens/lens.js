...
var zoom = function(o){
	...
	var r={t:0,l:0},
		...
		//2016.5.12改
		add(Math.max(d.body.scrollTop,d.documentElement.scrollTop),
			b.left+Math.max(d.body.scrollLeft,d.documentElement.scrollLeft));
    		...
    		ci.onmouseover = function(e){
				...
				if(!bimg.complete){
      			...
      			function showBimg(){
                    ...
                    bwidth = bimg.width+200,  //2016.5.12改bwidth = bimg.width
					bheight = bimg.height+100, //2016.5.12改bwidth = bimg.height
       				sx = bwidth/width-100, //2016.5.12改bwidth/width
       				sy = bheight/height;
